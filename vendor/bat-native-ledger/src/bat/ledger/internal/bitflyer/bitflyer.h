...
#ifndef BRAVELEDGER_BITFLYER_BITFLYER_H_
#define BRAVELEDGER_BITFLYER_BITFLYER_H_
...
//  std::unique_ptr<BitflyerCard> card_;
//  std::unique_ptr<BitflyerUser> user_;
...
#endif  // BRAVELEDGER_BITFLYER_BITFLYER_H_
