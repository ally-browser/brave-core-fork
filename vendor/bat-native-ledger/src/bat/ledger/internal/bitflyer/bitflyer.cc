...
// #include "bat/ledger/internal/bitflyer/bitflyer_card.h"
...
//    card_(std::make_unique<BitflyerCard>(ledger)),
//    user_(std::make_unique<BitflyerUser>(ledger)),
...
void Bitflyer::StartContribution(
  ...
  auto contribution_callback = std::bind(&Bitflyer::ContributionCompleted,
      this,
      _1,
      _2,
      contribution_id,
...
void Bitflyer::FetchBalance(FetchBalanceCallback callback) {
  ...
  auto url_callback = std::bind(&Bitflyer::OnFetchBalance,
      this,
      _1,
      _2,
      callback);
...
void Bitflyer::GetUser(GetUserCallback callback) {
//  user_->Get(callback);
}
